...
public class PlayerTutorial : MonoBehaviour
{
    ...
    void OnTriggerStay2D(Collider2D col)
    {
        /*if (col.tag == "Claw")
        {
            col.transform.parent.parent.GetComponent<ClawMovementTutorial>().caughtStuffy = true;
            col.transform.parent.parent.GetComponent<ClawMovementTutorial>().gameover = true;
